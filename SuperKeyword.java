...
class SB extends SA
{
    ...
    {
        super.display();
        System.out.println("Child B: "+x);//refers x value from same class.
        System.out.println("Child A: "+super.x);//refers x value from the parent SA class.
    }
}
